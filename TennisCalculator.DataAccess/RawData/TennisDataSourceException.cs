...
namespace TennisCalculator.DataAccess.RawData;
...
public class TennisDataSourceException : Exception
{
    ...
    [SetsRequiredMembers]
    public TennisDataSourceException(string message, string filePath, int? lineNumber = null) : base(message)
    {
        FilePath = filePath;
    ...
    /// <param name="lineNumber">The line number where the error occurred</param>
    [SetsRequiredMembers]
    public TennisDataSourceException(string message, string filePath, Exception innerException, int? lineNumber = null) 
