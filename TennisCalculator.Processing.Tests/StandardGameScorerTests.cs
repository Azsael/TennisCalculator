...
public class StandardGameScorerTests
{
    ...
    public void AddPoint_FirstPoint_UpdatesScoreToFifteen()
    {
        ...
        // Assert
        result.CurrentScore[_player1].Should().Be(TennisPoint.Fifteen);
        result.CurrentScore[_player2].Should().Be(TennisPoint.Love);
        result.PointHistory.Should().ContainSingle();
        result.PointHistory[0].Should().Be(_player1);
    ...
    public void AddPoint_DeuceScenario_ShowsFortyForty()
    {
        ...
        // Assert
        result.CurrentScore[_player1].Should().Be(TennisPoint.Forty);
        result.CurrentScore[_player2].Should().Be(TennisPoint.Forty);
        result.Winner.Should().BeNull();
    }
    ...
    public void AddPoint_AdvantageScenario_ShowsAdvantage()
    {
        ...
        // Assert
        result.CurrentScore[_player1].Should().Be(TennisPoint.Advantage);
        result.CurrentScore[_player2].Should().Be(TennisPoint.Forty);
        result.Winner.Should().BeNull();
    }
    ...
    public void CalculateCurrentScore_StandardScoring_ReturnsCorrectPoints(int points, TennisPoint expected)
    {
        ...
        // Assert
        result[_player1].Should().Be(expected);
        result[_player2].Should().Be(TennisPoint.Love);
    }
